...
||||
|`Enable.StoryQualityHook`|true| [Story]| 启用Story质量调整 |
...
|>> `MagicaCloth.MaxSimulationCountPerFrame`|5| [LiveStream]<br>[Story]| 布料模拟次数每帧 |
||||
|`Enable.FrameRateHook`|true| [全局]| 启用帧率修改钩
